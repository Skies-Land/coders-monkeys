...
export default function DesignSystem() {
    return (
        <>
            <Seo title="Design System" description="Explorez et découvrez les composants et les styles utilisés dans l'application pour assurer une cohérence visuelle et fonctionnelle." />
